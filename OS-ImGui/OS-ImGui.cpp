...
namespace OSImGui
{
    ...
    void OSImGui::MyCheckBox(const char* str_id, bool* v)
    {
        ...
        if (ImGui::IsItemHovered())
            Color = ImGui::GetColorU32(ImLerp(
                ImGui::GetStyleColorVec4(ImGuiCol_FrameBgHovered),
                ImVec4(ImGui::GetStyleColorVec4(ImGuiCol_CheckMark).x * 1.2f,
                    ImGui::GetStyleColorVec4(ImGuiCol_CheckMark).y * 1.2f,
                    ImGui::GetStyleColorVec4(ImGuiCol_CheckMark).z * 1.2f,
                    1.0f),
                t));
        else
            Color = ImGui::GetColorU32(ImLerp(
